    ...
    <div id="sidecontent">
        ...
        <ul id="dashboard-menu" >
       		 ...
       		 <c:when test="${sessionScope.dept=='Admin' }">
       		 	<c:set var='dept' value='jsp/businessCenter_adminServlet'></c:set>
       		 </c:when>
       		 <c:when test="${sessionScope.dept=='InspectionPersonnel' }">
       		 	<c:set var='dept' value='jsp/businessCenter_supervisorServclet'></c:set>
       		 </c:when>
       		 <c:when test="${sessionScope.dept=='LawEnforcingDept' }">
       		 	<c:set var='dept' value='jsp/businessCenter_justiceServclet'></c:set>
       		 </c:when>
       		 <c:otherwise >
            ...
            <c:when test="${sessionScope.dept =='Admin'}">
            	...
            	<li>
                	<a onclick="changeContent('jsp/managerServlet');" class="slider-bar-6"><em></em>人员管理</a>
            	</li>
       		 </c:when>
       		 </c:choose>
            <li>
