...
<body>
	<%
		...
		long d=date.getTime();
	%>
	<form action="createTaskList" method="post" enctype="multipart/form-data">
			<div class="task_1">
			...
			<div class="task_2">
				 <div class="task_title"><span class= "label label-badge label-primary">业务内容</span> </div>
					...
					<div id="imgPreview${i }" style='width:100; height:80;float: left;'><input type="file" name="src${i }" onchange="showImage(this,${i })" />	</div> 
					</c:forEach> 
			</div>
