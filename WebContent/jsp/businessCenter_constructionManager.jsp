	...
	<div id="list">
		...
		<div class="list_data">
			<div id="list_data0">
				...
				<center><form name="list_notifiction" method="GET"> 
					<%
					...
					%>
					<a href="businessCenter_constructionManagerServclet?page_notifiction=<%=i%>">[<%=i%>]
					</a>
					<%
						if(i>count_notifiction-1){
							if(i==count_notifiction-2){
					%>			<a
								href="businessCenter_adminServclet?page_notifiction=<%=i-2%>">[<%=i-2%>]
							</a>
					<%		}
							break;
						}else{
